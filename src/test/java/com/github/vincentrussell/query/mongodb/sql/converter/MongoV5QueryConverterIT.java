...
@Ignore
public class MongoV5QueryConverterIT extends AbstractQueryConverterIT {

    @ClassRule
    public static MongoRule mongoRule = new MongoRule(Version.V5_0_14);
//    public static MongoRule mongoRule = new MongoRule(Version.V7_0_4);
    ...
    public void joinInSubqueryAndJoinAgain() throws ParseException, JSONException, IOException {
        ...
        System.out.println(queryConverter.getQueryAsDocument().toJson());
        QueryResultIterator<Document> distinctIterable = queryConverter.run(mongoDatabase);
        List<Document> results = Lists.newArrayList(distinctIterable);
